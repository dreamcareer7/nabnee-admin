                    ...
                    <div class="table-responsive">
                      <base-table class="table align-items-center table-flush" :class="type === 'dark' ? 'table-dark': ''" :thead-classes="type === 'dark' ? 'thead-dark': 'thead-light'" tbody-classes="list" :data="quotesrequestData">
                        ...
                        <template slot-scope="{row,index}">
                            ...
                            <td class="budget">
                              <p style="text-transform: capitalize;">{{row.quote_id.item_name+'('+row.quote_id.type+')'}}</p>
                            </td>
                            <td class="budget">
                              <p style="text-transform: capitalize;">{{row.price}}</p>
                            </td>
                            <td class="budget">
                              <p style="text-transform: capitalize;white-space: normal;">{{row.remark}}</p>
                            </td>
                            <td class="budget">
                              <p style="display: block;vertical-align: middle;margin-top: 7px;"><span v-for="business_attachments in row.attachments" class="d-block"><a :href="business_attachments" target="_blank"><i class="fa fa-download mr-2"></i>download</a></span></p>
                            </td>
                            <td class="text-right">
                              <!-- <a class="btn btn-sm btn-success" :href="'#/viewcategory/'+row._id+'/'+row.inventory_category_id">View Quotations</a> -->
                            </td>
                        </template>
                      </base-table>
                    </div>
                      ...
                      <base-table class="table align-items-center table-flush" :class="type === 'dark' ? 'table-dark': ''" :thead-classes="type === 'dark' ? 'thead-dark': 'thead-light'" tbody-classes="list" :data="allquotesData">
                       <template slot="columns">
                        ...
                        <template slot-scope="{row,index}">
                            ...
                            <td class="budget">
                              <p style="display: block;vertical-align: middle;margin-top: 7px;"><span v-for="business_attachments in row.attachments"><a :href="business_attachments" target="_blank"><i class="fa fa-download mr-2"></i>download</a></span></p>
                            </td>
                            <td class="text-right">
                              <!-- <a class="btn btn-sm btn-success" :href="'#/viewcategory/'+row._id+'/'+row.inventory_category_id">View Quotations</a> -->
                            </td>
