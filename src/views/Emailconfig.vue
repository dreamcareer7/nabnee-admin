          ...
          >
            ...
            >
              <div class="row align-items-center">
                <div class="col-4">
                  <h3 class="mb-0">
                   Change password for no-reply email
                  </h3>
                </div>
                <div class="col-8">
  ...
  export default {
    ...
    changepassword() {
       ...
       if(this.model.newpassword===this.model.confirmpassword){
        this.errmessage='';
    axios
      .post(process.env.VUE_APP_API_ENDPOINT+'changemailpassword',querystring.stringify({id:localStorage.getItem('_id'),admin_password:this.model.newpassword }),this.auth)
      .then(response => {
