<template>
  <div>
                  ...
                  <div class="card shadow" :class="type === 'dark' ? 'bg-default': ''">
                    <div class="card-header border-0" style="background-color: #f9f9f9">
                      <div class="row align-items-center">
                        <div class="col-2">
                          <p class="mb-0">Filter products</p>
                        </div>
                        <div class="col-3">
                        ...
                        <div class="col-3">
                          <select  aria-describedby="addon-right addon-left" v-model="modals.item_subcategory" class="form-control form-control-alternative" autocomplete="off" @change="filterproduct()">
                        ...
                        <div class="col-3">
                          <select  aria-describedby="addon-right addon-left" class="form-control form-control-alternative" autocomplete="off" @change="filterbrandproduct()" v-model="modals.item_brand">
                    ...
                    <div class="container mt-3" v-if="!deleteitem">
                      <div class="row pb-4">
                        <div class="col-lg-4 mb-2" v-for="(product,index) in productData" >
                          <div>
                            <article class="card mb-2" >
                              <div class="product-image">
                                <img v-if="product.item_img==''" src="img/noimage.png" alt="Image"
                                  class="card-img-top">
                                  <img v-if="product.item_img!=''" :src="product.item_img[0]" alt="Image"
                                  class="card-img-top">
                              </div>
                              <div class="card-body">
                                <h4 class="card-title">
                                ...
                                <a target="_self" :href="'#/viewproduct/'+product.item_id" class="btn btn-sm btn-primary"><i class="fa fa-bath"></i> View product</a>
                                <base-button type="danger" size="sm" @click="deleteproduct(product)" icon="fa fa-trash">Delete</base-button>
                                <base-button type="success" size="sm" @click="openproduct(product)" icon="fa fa-pencil">Edit</base-button>
                              </div>
                            </article>
                          </div>
                        </div>
                ...
                <div class="row">
                  <div class="col">
                    <div class="card shadow" :class="type === 'dark' ? 'bg-default': ''">
                      <div class="card-header border-0" :class="type === 'dark' ? 'bg-transparent': ''">
                        <div class="row align-items-center">
                          <div class="col-md-12 d-flex text-center">
                            ...
                            <div class="col-md-1">
                              <base-button class="ml-2" type="primary" id="updatebtn" v-on:click="searchproduct()">Search</base-button>
                            </div>
                          </div>
                        </div>
                      </div>
                      <div class="container">
                        <div class="row pb-4">
                          <div class="col-lg-4 mb-2" v-for="(product,index) in searchData" >
                            <div>
                             <article class="card mb-2" >
                              <div class="product-image">
                                <img v-if="product.item_img==''" src="img/noimage.png" alt="Image"
                              ...
                              <div class="card-body">
                                ...
                                <a target="_self" :href="'#/viewcomments/'+product.item_id" class="btn btn-sm btn-primary"><i class="fa fa-bath"></i> View product</a>
                                <base-button type="danger" size="sm" @click="deleteproduct(product)" icon="fa fa-trash">Delete</base-button>
                              </div>
                            </article>
                            </div>
                        ...
                        <form @submit.prevent>
                         <div class="">
                          <div class="row px-2">
                            ...
                            <div class="col-lg-12 mb-2" v-if="model.item_type=='Product'">
                              <div class="row">
                                <div class="col-lg-4">
    ...
    <!-- view comments modal -->
    <modal :show.sync="modals.editproduct" class="bg-white full-modal">
      <h6 slot="header" class="modal-title" id="modal-title-default">Edit</h6>
        <template>
          <form @submit.prevent>
            <div class="row py-3 card shadow">
              <div class="col-md-12">
                <p class="border-bottom">Basic Details</p>
              </div>
              <div class="col-lg-12">
            ...
            <div class="row py-3 card shadow mt-3">
              ...
              <div class="col-12">
                <div class="row mt-3">
                  <div class="col-lg-4" v-for="(img,index) in modals.item_img" :key="img">
            ...
            <div class="row py-3 card shadow mt-3">
              <div class="col-md-12">
                <p class="border-bottom mb-2">Business User Details</p>
              </div>
              <div class="col-lg-12" >
                        <label class="form-control-label">Bisiness User</label>
                        <select
              ...
              <div class="col-lg-12" >
                     <label class="form-control-label">Projects</label>
                        ...
                        <div
                              v-if="$v.modals.project_id.$error"
                              class="error h5 text-danger mt-2 pl-1"
                            >
                              Field is required.
                        </div>
            ...
            <div class="row py-3 card shadow mt-3">
              <div class="col-md-12"><p class="border-bottom mb-2">Additional Details</p></div>
              <div class="col-lg-12" >
                <label class="form-control-label">Select category</label>
                    <select
                          aria-describedby="addon-right addon-left"
        ...
        <template slot="footer">
            ...
            <base-button type="link" class="ml-auto" @click="modals.editproduct = false">Close
            </base-button>
        </template>
    </modal>
...
<script>
  ...
  export default {
    ...
    mounted () {
      ...
      axios
      .post(process.env.VUE_APP_API_ENDPOINT+'read_inventory_all',{"details" :{ "item_type":"Product"},"offset" :"0"})
      .then(response => {
  ...
  saveitem(){
    ...
    previouspage(){
      ...
      --this.offset;
      axios
      .post(process.env.VUE_APP_API_ENDPOINT+'read_inventory_all',{"details" :{ "item_type":"Product"},"offset" :this.offset})
      .then(response => {
        console.log(response);
        if(response.data.details){
        this.productData=response.data.details;
    ...
    filterproduct() {
      const querystring = require('querystring');
      axios
      .post(process.env.VUE_APP_API_ENDPOINT+'read_inventory_all',{"offset":"0","details":{"item_type":"Product","item_category":this.modals.item_category,"item_subcategory":this.modals.item_subcategory}})
      .then(response => {
        console.log(response);
        if(response.data.details){
          this.deleteitem=false;
    ...
    filtercategoryproduct() {
      const querystring = require('querystring');
      axios
      .post(process.env.VUE_APP_API_ENDPOINT+'read_inventory_all',{"offset":"0","details":{"item_type":"Product","item_category":this.modals.item_category}})
      .then(response => {
        console.log(response);
        if(response.data.details){
          this.deleteitem=false;
    ...
    filterbrandproduct() {
      ...
      const querystring = require('querystring');
      axios
      .post(process.env.VUE_APP_API_ENDPOINT+'read_inventory_all',{"offset":"0","details":{"item_type":"Product","item_brand":this.modals.item_brand}})
      .then(response => {
        console.log(response);
        if(response.data.details){
          this.deleteitem=false;
